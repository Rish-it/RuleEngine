...
const CombineRules = () => {
    ...
    return (
        <div className="max-w-md mx-auto my-8 p-6 bg-gray-900 rounded-lg shadow-lg">
            <h1 className="text-2xl font-bold text-white mb-4">Combine Rules</h1>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2">
                    <button
                        ...
                        className="w-full py-2 bg-blue-500 text-white rounded-full hover:bg-blue-700 transition duration-200"
                    >
                        Add Another
                    </button>
                    <button
                        type="submit"
                        className="w-full py-2 bg-green-500 text-white rounded-full hover:bg-green-700 transition duration-200"
                    >
                        Combine Rules
                    </button>
                </div>
