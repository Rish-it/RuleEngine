...
const EvaluateRules = () => {
    ...
    return (
        <div className="max-w-md mx-auto my-8 p-6 bg-gray-900 rounded-lg shadow-lg">
            <h1 className="text-2xl font-bold text-white mb-4">Evaluate Rules</h1>
            <form onSubmit={handleSubmit} className="space-y-4">
                <textarea
                    ...
                    required
                    className="w-full h-32 p-2 border border-gray-600 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none"
                />
                <textarea
                    value={data}
                    ...
                    className="w-full h-32 p-2 border border-gray-600 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none"
                />
                <button type="submit" className="w-full py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition duration-200">
                    Evaluate Rule
                </button>
            </form>
            {response && (
